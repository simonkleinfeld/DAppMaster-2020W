...
function main(params) {
  ...
  const successRate = params.successRate

  const probability = Math.floor(Math.random() * 100);

  if(successRate < probability){
    return resolveAfter10Seconds()
  }else {
    return fraction(params)
  }
